...
public class InventoryPage extends BasePage {
    ...
    public void clickAddInventory() throws InterruptedException {
        WebElement addInventory_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//b[text()='Add Inventory']");
        addInventory_ele.click();
    }

    public void clickSelectProductCategory() throws InterruptedException {
        Thread.sleep(5000);
        WebElement productCategoryButton=InventoryPage.super.findAnyElement(All_Locators.CLASSNAME,"select-placeholder-text-prod-category");
    ...
    public void clickSelectProductName() throws InterruptedException {
        WebElement ele_productName=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//div[text()='Select Product Name']");
    ...
    public void enterBatchNumber(String batchNumber){
        WebElement batchNumber_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//input[@placeholder='Enter Batch No']");
        batchNumber_ele.sendKeys(batchNumber);
    }

    public void enterQuantity(String quantity){
        WebElement quantity_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//input[@placeholder='Enter Quantity']");
        quantity_ele.sendKeys(quantity);
    }

    public void clickOnAddDetails(){
        WebElement addDetails_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//span[@class='txt-inventory']");
        addDetails_ele.click();
    }

    public void clickOnManufactureDate() throws InterruptedException {
        WebElement manufacutedate_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//input[@placeholder='Enter Mfg Date']");
    ...
    public void enterManufactureYearDate(String year_value,String month_value) throws InterruptedException {
        ...
        WebElement ele_year=wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//div[@class='react-datepicker__month-container']/div[1]")));
        while(true){
            String year=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//div[@class='react-datepicker__month-container']/div[1]").getText();
        ...
        //month selection
        List<WebElement> allMonths=InventoryPage.super.findAllElements(All_Locators.XPATH,"//div[@aria-selected='false']");
    ...
    public void clickExpireDate(){
        WebElement expireDate_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//input[@placeholder='Enter Exp Date']");
    ...
    public void enterSerialNumber(String serialNumber){
        WebElement serialNumber_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//input[@placeholder='Enter Serial Numbers']");
        serialNumber_ele.sendKeys(serialNumber);
    }

    public void clickReviewProduct(){
        WebElement reviewProduct_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//b[text()='Review Product']");
    ...
    public void clickAddNewProduct(){
        WebElement clickViewAll_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//b[text()='Add new product']");
    ...
    public void clickManufacturer(){
        WebElement manufacturer_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//input[@placeholder='Enter manufacturer']");
        manufacturer_ele.click();
    }

    public void selectManufacturers(String manufacturerName) throws InterruptedException {
        List<WebElement> manufacturers_list=InventoryPage.super.findAllElements(All_Locators.XPATH,"//li[@tabindex='-1']");
    ...
    public void clickproductCategory(){
        WebElement productCategory_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//input[@placeholder='Product Category']");
        productCategory_ele.click();
    }

    public void selectProductCategory(String productCategory) throws InterruptedException {
        List<WebElement> productCategory_list=InventoryPage.super.findAllElements(All_Locators.XPATH,"//li[@tabindex='-1']");
    ...
    public void enterUnitOfMeasure(String unit){
        WebElement unit_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//input[@placeholder='Enter Unit of Measure']");
        unit_ele.sendKeys(unit);
    }

    public void enterShortDescription(String description){
        WebElement description_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//input[@placeholder='Enter Short Description']");
        description_ele.sendKeys(description);
    }

    public void clickAddNewProductButton(){
        WebElement addNewProduct_button=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//span[text()='Add new product']");
        addNewProduct_button.click();
    }

    public void clickOnAddNewCategory(){
        WebElement addnewcategory_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//a[@href='/addNewCategory']");
        addnewcategory_ele.click();
    }

    public void enterCategoryName(String categoryName){
        WebElement categoryName_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//input[@placeholder='Enter Category Name']");
        categoryName_ele.sendKeys(categoryName);
    }

    public void enterDescriptionForCategory(String categoryDescription){
        WebElement categoryDescription_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//input[@placeholder='Enter Description']");
        categoryDescription_ele.sendKeys(categoryDescription);
    }

    public void clickAddNewCategory(){
        WebElement addNewCategory_ele=InventoryPage.super.findAnyElement(All_Locators.XPATH,"//span[text()='Add new category']");
        addNewCategory_ele.click();
    }
}
